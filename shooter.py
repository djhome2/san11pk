...
def main_menu():
    ...
    menu_song = Sound(path.join(sound_folder, "menu.ogg"))
    menu_song.play()
...
shooting_filename = path.join(sound_folder, 'pew.m4a')
assert(os.path.exists(shooting_filename))
shooting_sound = Sound(shooting_filename)
missile_sound = Sound(path.join(sound_folder, 'rocket.ogg'))
expl_sounds = []
for sound in ['expl3.ogg', 'expl6.ogg']:
    expl_sounds.append(Sound(path.join(sound_folder, sound)))
# main background music
#pygame.mixer.music.load(path.join(sound_folder, 'tgfcoder-FrozenJam-SeamlessLoop.ogg'))
pygame.mixer.music.set_volume(0.2)  # simmered the sound down a little

player_die_sound = Sound(path.join(sound_folder, 'rumble1.ogg'))
###################################################
